...
from fsdet.data.builtin_meta import (
    COCO_TD_CATEGORIES,
...
class COCOTDEvaluator(DatasetEvaluator):
    """
    ...
    def __init__(self, dataset_name, cfg, distributed, output_dir=None):
        ...
        # fmt: off
        self._base_classes = [x["id"] for x in COCO_TD_CATEGORIES if x["id"] not in [y["id"] for y in COCO_TD_NOVEL_CATEGORIES]]
        # fmt: on
